...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void testFahrenheitCelsius_MonPropreTest()
    {
        assertEquals("    1 °F -> -17.2 °C ? ", -17.2, question1.FahrenheitCelsius.fahrenheitEnCelsius(1), 0.1);
        assertEquals("  20 °F -> -6.6 °C ? ", -6.6, question1.FahrenheitCelsius.fahrenheitEnCelsius(20), 0.1);
        assertEquals("  50 °F -> 10.0 °C ? ", 10.0, question1.FahrenheitCelsius.fahrenheitEnCelsius(50), 0.1);
